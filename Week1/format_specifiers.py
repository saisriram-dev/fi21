...
print(
    f"Price 2 is {price2:10.2f}"
)  # The total width is 10 including decimal point and digits after it.
print(
    f"Price 3 is {price3:12.3f}"
)  # The total width is 12 including decimal point and digits after it

# Padding zeros instead of spaces
print(f"Price 1 is {price1:010}")  # Padding with zeros to make total width 10
print(
    f"Price 2 is {price2:010.0f}"
)  # Padding with zeros to make total width 10 including the decimal points
print(
    f"Price 3 is {price3:012.1f}"
)  # Padding with zeros to make total width 12 including the decimal points
...
print(f"Price 1 is {price1:<10}")
print(
    f"Price 2 is {price2:<10,.0f}"
)  # Spaces will be added to the right to make total width 10 including commas
print(f"Price 3 is {price3:<12,.1f}")
...
print(
    f"Price 2 is {price2:>10,.0f}"
)  # Spaces will be added to the left to make total width 10 including commas
print(f"Price 3 is {price3:>12,.1f}")
...
print(
    f"Price 2 is {price2:^10,.0f}"
)  # Spaces will be added to both sides to make total width 10 including commas
print(
    f"Price 3 is {price3:^12,.1f}"
)  # Spaces will be added to both sides to make total width 12 including commas
