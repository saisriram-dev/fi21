...
groceries = [
    ...
    vegetables,
    meats,
]  # groceries[0] is the fruits list, groceries[1] is the vegetables listand so on.
print(
    groceries
)  # Output: [['apple', 'banana', 'cherry', 'date'], ['asparagus', 'broccoli', 'carrot', 'daikon'], ['beef', 'chicken', 'pork', 'lamb']]
