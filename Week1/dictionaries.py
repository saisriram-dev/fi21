...
capitals.update(
    {"Japan": "Tokyo"}
)  # This adds a country Japan along with it's capital as value
...
anime_country = (
    capitals.popitem()
)  # It removes the most recent entry or simply the last pair
print(anime_country)
print(capitals)
...
items = (
    capitals.items()
)  # Creates a 2D list of tuples which contain the key-value pairs
print(items)
