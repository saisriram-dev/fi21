...
with open("Week6/CSV/students.csv", "r", newline="", encoding="utf-8") as file:
    ...
    reader1 = csv.reader(file) # reader stores the content of the csv file in a list format
    ...
    file.seek(0) # This is done to reset the pointer to the start of the file
    reader2 = csv.DictReader(file) # reader stores the content of the csv file in a dictionary format
    for row in reader2:
        print(row)
    print()
