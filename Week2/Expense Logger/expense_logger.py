file_path = (
    "C:/Users/P SAI SRI RAM/OneDrive/Desktop/fi21/Week2/Expense Logger/expenses.txt"
)
...
with open(file_path, "r") as file:
    ...
    ]  # file.readlines() gives a list as output
    lines = [
        int(line) for line in lines
    ]  # Converting each item in the list to integer type
    print(lines)
